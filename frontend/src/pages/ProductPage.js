        ...
        <Container className="pt-4" style={{ position: "relative" }}>
            <Row>
                ...
                <Col lg={6} className="pt-4">
                    ...
                    <p className="product__price">Php{product.price}</p>
                    ...
                    {user && !user.isAdmin && (
                        <ButtonGroup style={{ width: "90%" }}>
                            ...
                            <Button variant="outline-dark" size="lg" onClick={() => addToCart({ userId: user._id, productId: id, price: product.price, image: product.pictures[0].url })}>
                                Add to cart
                            </Button>
                        </ButtonGroup>
                    )}
                    {user && user.isAdmin && (
                        <LinkContainer to={`/product/${product._id}/edit`}>
                            <Button variant="outline-dark" size="lg">Edit Product</Button>
                        </LinkContainer>
                    )}
