...
import matchBookLogo from "../images/marion logo.png";
    ...
    return (
        <Navbar bg="light" expand="lg">
            <Container>
                ...
                <div>
                    <div className="row-lg-3 mx-auto">
                        <div className="navbar__logo">
                            <img src={matchBookLogo} alt="match-book logo" width="150" height="150" />
                        </div>                 
                    </div>
                </div>
                        ...
                        {user && (
                            <>
                                ...
                                <NavDropdown title={`${user.email}`} id="basic-nav-dropdown">
                                    ...
                                    <NavDropdown.Divider />
                                    <Button variant="outline-dark" onClick={handleLogout} className="logout-btn">
                                        Logout
                                    </Button>
